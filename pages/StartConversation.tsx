...
export const StartConversation: React.FC = () => {
  ...
  // ✅ This is the wired submit handler (sends to Vercel API -> Resend)
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 animate-in fade-in zoom-in duration-700 bg-white min-h-[70vh] flex items-center justify-center">
        <div className="max-w-3xl bg-slate-50 p-10 lg:p-20 rounded-[4rem] border border-slate-100 shadow-inner text-left">
          ...
          <p className="text-xl text-slate-700 mb-10 font-medium leading-relaxed">
            We’ve received your information and will review it through a systems-first lens. Our next step is to confirm
            fit and identify the highest-leverage path forward — not to push a pre-packaged service.
          </p>
            ...
            <ul className="space-y-6">
              <li className="flex items-start gap-4">
                ...
                <p className="text-slate-600 font-medium">
                  We review your responses to understand your current growth environment and desired outcomes.
                </p>
              </li>
              <li className="flex items-start gap-4">
                <div className="w-1.5 h-1.5 bg-veye-blue rounded-full mt-2 shrink-0"></div>
                <p className="text-slate-600 font-medium">
                  We follow up within 1 business day to schedule a short strategic conversation (typically 15–30 minutes).
                </p>
              </li>
              <li className="flex items-start gap-4">
                <div className="w-1.5 h-1.5 bg-veye-blue rounded-full mt-2 shrink-0"></div>
                <p className="text-slate-600 font-medium">
                  If it’s a fit, we’ll outline the right system approach, the surfaces it will coordinate, and what a
                  phased engagement could look like.
                </p>
              </li>
            </ul>
          </div>
          ...
          <p className="text-sm text-slate-400 font-bold italic mb-12 py-6 border-y border-slate-200/60">
            “We don’t ask for tools, workflows, or internal implementation details in this step. This is about outcomes,
            alignment, and building the right system.”
          </p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start mb-24">
        <div>
          ...
          <p className="text-xl text-slate-600 leading-relaxed mb-16 font-medium">
            Acquiring an intelligent growth system begins with a rigorous discovery process. We seek to understand the
            systemic barriers to your organization's continuity and the strategic mandate you aim to fulfill.
          </p>
          ...
          <div className="space-y-12">
            <div className="flex gap-8">
              ...
              <div>
                ...
                <p className="text-slate-600 font-medium">
                  Our dialogue is focused on identifying high-fidelity automation opportunities rather than transient
                  campaign tactics.
                </p>
              </div>
            </div>
        ...
        <form className="space-y-10" onSubmit={handleSubmit} noValidate>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 text-left">
            ...
            <div className="space-y-3">
              <label className="text-[11px] font-extrabold text-slate-400 uppercase tracking-widest flex justify-between">
                Operational Scale{' '}
                {errors.operationalScale && (
                  <span className="text-veye-amber flex items-center gap-1">
                    <AlertCircle size={10} /> {errors.operationalScale}
                  </span>
                )}
              </label>
              <div className="relative">
          ...
          <div className="space-y-3 text-left">
            <label className="text-[11px] font-extrabold text-slate-400 uppercase tracking-widest flex justify-between">
              Strategic Mandate (Required Outcome){' '}
              {errors.mandate && (
                <span className="text-veye-amber flex items-center gap-1">
